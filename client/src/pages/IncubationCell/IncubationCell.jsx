...
const alumniData = [
  {
    ...
    image: "https://siddhartha.ac.in/img/about/SekharBabu1.jpg",
    about:
  ...
  },
  {
    ...
    image: "https://siddhartha.ac.in/img/about/Dr.G.Nagaiah_Pic.jpg",
    about:
      "At SIDDHARTHA, real-world leadership challenges come to life. Our programs and courses will help you learn how to think expansively, act decisively, and inspire those around you to achieve great things.",
  },
  {
    ...
    image: "https://siddhartha.ac.in/img/about/Dr.D.Pradeep_pic.jpg",
    about:
      "At SIDDHARTHA, real-world leadership challenges come to life. Our programs and courses will help you learn how to think expansively, act decisively, and inspire those around you to achieve great things.",
  },
  {
    ...
    <>
      ...
      <div className="flex flex-wrap gap-6 justify-center">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://media.getmyuni.com/azure/college-images-test/sri-siddhartha-institute-of-technology-ssit-tumkur/a420cf58cfb74694b623b3ded7a77a71.jpeg')",
          }}
        >
          {/* Overlay Gradient */}
          <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/50 to-transparent"></div>
          ...
          <div className="absolute inset-0 flex flex-col justify-start p-6 text-white space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-200 mb-3 leading-relaxed font-sans">
                Siddhartha provides access to diverse funding sources,
                empowering aspiring entrepreneurs with the financial resources
                necessary to turn their groundbreaking ideas into successful
                ventures.
              </p>
              <a
                href="#"
      ...
      <section className="bg-gray-200 py-12 px-6 md:px-24">
        <div className="  max-w-7xl mx-auto text-left">
          ...
          <p className="mt-6 text-base text-gray-700 leading-relaxed font-medium max-w-3xl mb-8">
            The Innovation Cell at SIDDHARTHA brings together resources, ideas,
            and people to create an innovative environment for students and
            faculty. It encourages creativity and helps students turn their
            concepts into real-world business solutions. The Innovation Cell
            provides access to the institution’s resources, such as workshops,
            labs, libraries, and research centers.
          </p>
      ...
      <div className="flex flex-wrap gap-6 justify-center">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-start p-6 text-white space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-200 mb-3 leading-relaxed font-sans">
                The EDC at SIDDHARTHA promotes entrepreneurship among women
                through workshops, panel discussions, and a technology
                incubation center. In partnership with JNTU, Hyderabad, the EDC
                nurtures entrepreneurial spirit and provides infrastructure
                support to startups.
              </p>
              <a
                href="#"
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-start p-6 text-white space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-200 mb-3 leading-relaxed font-sans">
                The IPR Cell at SIDDHARTHA is dedicated to identifying,
                protecting, and leveraging intellectual property generated
                through research and innovation. It provides a platform for the
          ...
          <div className="absolute inset-0 flex flex-col justify-start p-6 text-white space-y-4">
            ...
            <div>
              <p className="text-sm text-gray-200 mb-3 leading-relaxed font-sans">
                ...
                culture for more things to Innovation amongst all Higher
      ...
      <section className="bg-[#004d40] text-white py-12 px-6 md:px-24">
        <div className="max-w-6xl mx-auto">
          {/* Heading */}
          <h1 className="text-4xl font-bold mb-6">Innovation Policies</h1>
          {/* Paragraph */}
          <p className="text-lg leading-relaxed font-medium max-w-4xl mb-8">
            The Policies at SIDDHARTHA support innovation, entrepreneurship, and
            IP protection. The Innovation and Incubation Policy fosters
            women-led Deep Tech startups aligned with UNSDGs. The
            Entrepreneurship Development Policy provides resources and
            mentorship for business creation. The IPR Policy safeguards and
            commercializes intellectual property. The NISP, through the IIC,
            promotes a startup culture, encouraging collaboration and innovation
            across industries. Together, these policies create a robust
            ecosystem for sustainable entrepreneurship and technological
            advancement.
          </p>
          {/* Buttons */}
