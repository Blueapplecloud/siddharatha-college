        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 md:p-12 flex flex-col md:flex-row justify-between items-center gap-10">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-lg leading-relaxed text-gray-700">
              ...
              students with a rich learning environment and holistic development.
              The institution is built with modern infrastructure that encourages
              both academic achievement and individual growth. A wide variety of
              student-led clubs and communities provide avenues for co-curricular
              engagement, innovation, and recreation. Annual fests and
              inter-college competitions offer platforms to showcase talent,
              explore new interests, and grow beyond academics.
            </p>
          </div>
